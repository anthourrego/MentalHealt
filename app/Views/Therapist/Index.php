  ...
  <div class="modal-dialog">
    <div class="modal-content">
          ...
          <div class="row mb-3">
            <div class="col-md-12">
              <div class="mb-3">
                ...
                <textarea class="form-control" id="appointmentAnotation" name="content" rows="5" required minlength="1" maxlength="1000" placeholder=""></textarea>
              </div>
            </div>
          </div>
        </form>
          ...
          <div class="row mb-3">
            <div class="col-md-12">
              <div class="mb-3">
                ...
                <textarea class="form-control" id="urlVideo" name="content" rows="2" required minlength="1" maxlength="250" placeholder=""></textarea>
              </div>
            </div>
          </div>
        </form>
      ...
      <div class="modal-footer">
        ...
        <button type="button" id="btnCompleted" form="formCompleted" class="btn btn-success"><i class="fa-solid fa-check"></i> Completada</button>
        <button type="button" id="btnConfirmed" form="formConfirmed" class="btn btn-success"><i class="fa-solid fa-check"></i> Confirmado</button>
